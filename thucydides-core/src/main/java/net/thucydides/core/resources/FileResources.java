...
public class FileResources {
	...
	public String findTargetSubdirectoryFrom(String sourceResource) {
		...
		if (relativePath.contains("/") || relativePath.contains("\\")) {
			File relativeFilepath = new File(relativePath);
			return relativeFilepath.getParent();
		} else {
			return "";
		}
	}
	...
	public String findTargetFileFrom(String sourceResource) {
		...
		if (relativePath.contains(FILE_SEPARATOR)) {
			File relativeFilepath = new File(relativePath);
			return relativeFilepath.getName();
		} else {
			return relativePath;
		}
	}

	public void copyResourceTo(String sourceResource, File targetDirectory)
			throws IOException {
