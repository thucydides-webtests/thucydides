...
public class HibernateTestOutcomeHistoryDAO implements TestOutcomeHistoryDAO {
    ...
    @Inject
    public HibernateTestOutcomeHistoryDAO(EntityManager entityManager, SystemClock clock) {
    ...
    public void storeTestOutcomes(List<TestOutcome> testOutcomes) {
        ...
        for(TestOutcome testOutcome : testOutcomes) {
            TestRun storedHistory = TestRun.from(testOutcome).at(clock.getCurrentTime().toDate());
