...
public class WhenGeneratingAJSONReportSpock {
    ...
    public void should_generate_an_JSON_report_for_an_acceptance_test_run()
        ...
        String expectedReport = 
        		...
        		"  \"name\": \"should_do_this\",\n" + 
        		"  \"test-case\": {\n" + 
        		"    \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$SomeTestScenario\"\n" + 
        		"  },\n" + 
        		"  \"result\": \"SUCCESS\",\n" + 
        		"  \"steps\": \"1\",\n" + 
        		"  \"successful\": \"1\",\n" + 
        		...
        		"  \"user-story\": {\n" + 
        		"    \"userStoryClass\": {\n" + 
        		"      \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$AUserStory\"\n" + 
        		"    },\n" + 
        		"    \"qualifiedStoryClassName\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock.AUserStory\",\n" + 
        		"    \"storyName\": \"A user story\",\n" + 
        		"    \"path\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock\"\n" + 
        		"  },\n" + 
        		"  \"issues\": [],\n" + 
        		"  \"tags\": [\n" + 
        		"    {\n" + 
    ...
    public void should_include_issues_in_the_JSON_report()
        ...
        String expectedReport = 
        	...
        	"  \"name\": \"should_do_this\",\n" + 
        	"  \"test-case\": {\n" + 
        	"    \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$ATestScenarioWithIssues\",\n" + 
        	"    \"issues\": [\n" + 
        	"      \"#123\",\n" + 
        	"      \"#456\",\n" + 
        	"      \"#789\"\n" + 
    ...
    public void should_store_tags_in_the_JSON_reports()
        ...
        String expectedJSonReport = 
        			...
        			"  \"name\": \"should_do_this\",\n" + 
        			"  \"test-case\": {\n" + 
        			"    \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$SomeTestScenarioWithTags\"\n" + 
        			"  },\n" + 
        			"  \"result\": \"SUCCESS\",\n" + 
        			"  \"steps\": \"1\",\n" + 
        			"  \"successful\": \"1\",\n" + 
        			...
        			"      \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$SomeTestScenarioWithTags\"\n" + 
        			"    },\n" + 
        			"    \"qualifiedStoryClassName\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock.SomeTestScenarioWithTags\",\n" + 
    ...
    public void the_xml_report_should_contain_the_feature_if_provided()
        ...
        String expectedJsonReport =
        		...
        		"  \"name\": \"should_do_this\",\n" + 
        		"  \"test-case\": {\n" + 
        		"    \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$SomeTestScenarioInAFeature\"\n" + 
        		"  },\n" + 
        		"  \"result\": \"SUCCESS\",\n" + 
        		"  \"steps\": \"1\",\n" + 
        		"  \"successful\": \"1\",\n" + 
        		...
        		"  \"user-story\": {\n" + 
        		"    \"userStoryClass\": {\n" + 
        		"      \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$AFeature$AUserStoryInAFeature\"\n" + 
        		"    },\n" + 
        		"    \"qualifiedStoryClassName\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock.AFeature.AUserStoryInAFeature\",\n" + 
        		"    \"storyName\": \"A user story in a feature\",\n" + 
        		"    \"path\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock.AFeature\",\n" + 
        		"    \"qualifiedFeatureClassName\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock.AFeature\",\n" + 
    ...
    public void should_record_test_groups_as_nested_structures()
        ...
        String expectedJsonReport 
			...
			"  \"test-case\": {\n" + 
			"    \"classname\": \"net.thucydides.core.reports.integration.WhenGeneratingAJSONReportSpock$SomeNestedTestScenario\"\n" + 
			"  },\n" + 
			"  \"result\": \"SUCCESS\",\n" + 
			"  \"steps\": \"3\",\n" + 
			"  \"successful\": \"3\",\n" + 
