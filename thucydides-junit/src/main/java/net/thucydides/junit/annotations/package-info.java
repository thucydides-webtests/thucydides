 ...
 * The {@link Managed} annotation declares a WebDriver field so that it's lifecycle can be 
 * managed by the Thucydides test runner. 
 * Other annotations are used to provide extra information for the test reports.
 * The {@link Title} annotation can be used to override the default test case title
