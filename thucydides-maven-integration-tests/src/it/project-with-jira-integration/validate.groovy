...
// TODO:
//htmlStoriesReport = new File("${basedir}/target/thucydides/stories.html")
...
def testReport = new File("${basedir}/target/thucydides/sample_test_scenario_happy_day_scenario.html").text
